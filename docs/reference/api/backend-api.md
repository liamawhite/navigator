...
| proxy_mode | [navigator.types.v1alpha1.ProxyMode](#navigator-types-v1alpha1-ProxyMode) |  | proxy_mode indicates the type of Istio proxy running in this instance. |
