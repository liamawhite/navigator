...
type MeshMetricsProvider interface {
	GetServiceGraphMetrics(ctx context.Context, clusterID string, req *frontendv1alpha1.GetServiceGraphMetricsRequest) (*typesv1alpha1.ServiceGraphMetrics, error)
}
