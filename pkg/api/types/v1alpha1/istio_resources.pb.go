...
var file_types_v1alpha1_istio_resources_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x88, 0x01, 0x0a, 0x17, 0x49, 0x73, 0x74, 0x69,
...
var file_types_v1alpha1_istio_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_types_v1alpha1_istio_resources_proto_goTypes = []any{
	...
	(*IstioControlPlaneConfig)(nil), // 10: navigator.types.v1alpha1.IstioControlPlaneConfig
	nil,                             // 11: navigator.types.v1alpha1.DestinationRuleSubset.LabelsEntry
	nil,                             // 12: navigator.types.v1alpha1.WorkloadSelector.MatchLabelsEntry
	nil,                             // 13: navigator.types.v1alpha1.Gateway.SelectorEntry
}
var file_types_v1alpha1_istio_resources_proto_depIdxs = []int32{
	...
	11, // 2: navigator.types.v1alpha1.DestinationRuleSubset.labels:type_name -> navigator.types.v1alpha1.DestinationRuleSubset.LabelsEntry
	12, // 3: navigator.types.v1alpha1.WorkloadSelector.match_labels:type_name -> navigator.types.v1alpha1.WorkloadSelector.MatchLabelsEntry
	...
	13, // 6: navigator.types.v1alpha1.Gateway.selector:type_name -> navigator.types.v1alpha1.Gateway.SelectorEntry
