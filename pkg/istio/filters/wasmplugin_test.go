...
func TestFilterWasmPluginsForWorkload(t *testing.T) {
	...
	result := FilterWasmPluginsForWorkload(wasmPlugins, instance, "default", "istio-system")
...
func TestWasmPluginMatchesWorkload(t *testing.T) {
	tests := []struct {
		name          string
		wp            *typesv1alpha1.WasmPlugin
		instance      *backendv1alpha1.ServiceInstance
		namespace     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := wasmPluginMatchesWorkload(tt.wp, tt.instance, tt.namespace, tt.rootNamespace)
